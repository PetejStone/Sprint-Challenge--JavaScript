...
/* Request 1: Create a new array called universities that contains all the
univeristies in the graduates array.
...
the email information like this:
...
The zoo wants to display both the scientific name and the animal name in front of
the habitats.  Return an array with only the animal and scientific names in it.
...
const population = [];
zooAnimals.forEach(animal => {
  population.push(animal.population);
});
